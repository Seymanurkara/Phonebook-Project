...
pip3 install boto3
dnf install git -y
echo "seymanur-phonebook-app.cbanmzptkrzf.us-east-1.rds.amazonaws.com" > /home/ec2-user/dbserver.endpoint
cd /home/ec2-user
...
git clone https://$TOKEN@github.com/Seymanurkara/phonebook-web-app.git
